...
def update_screen(ai_settings, screen, stats, sb, ship, bunker, aliens, bullets, play_button):
...
def get_number_aliens_x(ai_settings, alien_width):
    """Determine number of aliens that fit window"""
...
def change_fleet_direction(ai_settings, aliens):
    """drop entire fleet and change the flets direction."""
    for alien in aliens.sprites():
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """ Check if fleet is at an edge,update the positions of all aliens in the fleet."""
